...
/* template */
var __vue_render__$1 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":_vm.transitionRoot}},[(_vm.isVisible)?_c('div',{class:_vm.styling.root,on:{"click":_vm.onClick,"keydown":_vm.onKeydown}},[_c('transition',{attrs:{"name":_vm.transitionContent,"appear":""}},[_c(_vm.tag,{ref:"content",tag:"component",class:_vm.styling.content,attrs:{"tabindex":"-1","role":"dialog"}},[_vm._t("default")],2)],1)],1):_vm._e()])};
...
var __vue_staticRenderFns__$b = [];
  ...
  var __vue_inject_styles__$d = function (inject) {
    if (!inject) { return }
    inject("data-v-6525fa2c_0", { source: ".slide-fade-enter-active{position:relative;z-index:-1;transition:all .2s ease-in-out}.slide-fade-leave-active{position:relative;z-index:-1;transition:all .2s ease-in-out}.slide-fade-enter,.slide-fade-leave-to{position:relative;z-index:-1;opacity:0;transform:translateY(-100%)}.vts-toggle__content{transition:all .3s ease-in-out}", map: undefined, media: undefined });
